docReady(function() {
    ...
    const valueString = document.getElementById('bw-chart-value-array').innerText;
    var arcArray = document.querySelectorAll('#page_3 #Inner_Pie .arc');
    ...
    //Append custom Chart background
    ...
    // // Adjust Inner circle opacity
    // var valueArray = valueString.split("|");
    // for (var i = 0; i < arcArray.length; i++) {
    //     var newNode = document.querySelectorAll('#page_3 #Inner_Pie .arc')[i].appendChild(arcArray[i].childNodes[0].cloneNode(true));
    //     document.querySelectorAll('#page_3 #Inner_Pie .arc')[i].childNodes[0].style.display = "none";
    //     newNode.style.transform = "scale(" + Number(0.55 + (i * 0.22)) + ")";
    //     newNode.style.fill = valueArray[i];
