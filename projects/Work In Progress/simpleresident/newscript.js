docReady(function() {
    ...
    if (score) {
        if (q1 == 25 && q1Res == '18 to 24') {
            list.innerHTML += `<li>Gain 5 extra points when you turn 25 years. Continue to study or gain employment experience to accumulate more points. </li>`;
        } else if (q1 == 30) {
            list.innerHTML += `<li>This is the best time to apply. Applicants between the age of 25 and 32 get the maximum points for age. </li>`;
        } else if (q1 == 25 && q1Res == '33 to 39') {
            list.innerHTML += `<li>Apply before your 33rd birthday to ensure you have the most possible age-related points. Once you turn 33, you will lose 5 age-related points. To avoid this risk, consider applying as soon as you reasonably can.</li>`;
        } else {
        ...
        if (q6 == 20) {
            ...
            list.innerHTML += `<li>Consider undertaking further study that is closely related to your occupation for additional points. If you earn an eligible Bachelor’s or Master’s degree directly related to your profession, you may be able to earn 5 additional points.</li>`;
        } else {
            list.innerHTML += `<li>FAn eligible degree may increase your points score by an additional 10-20 points. </li>`;
        }
        ...
        if (q8 == 15) {
            list.innerHTML += `<li>Your overseas employment experience has earned you 15 points. If you have any breaks in your overseas employment or you have moved to Australia, your points score can change if some of your experience starts to fall outside of the 10-year period. Take care to ensure your points claim is correct.</li>`;
        } else if (q8 == 10) {
            list.innerHTML += `<li>If you are currently outside of Australia, you can claim additional points for overseas employment experience once you have 8 years of employment experience in your occupation. Also be aware of the risks. If some of your experience falls back past the last 10 years, you could lose points. Take care to ensure your points claim is correct.</li>`;
        } else if (q8 == 5) {
            list.innerHTML += `<li>If you are currently outside of Australia, you can claim additional points for overseas employment experience once you have 5 years of employment experience in your occupation. Also be aware of the risks. If some of your experience falls back past the last 10 years, you could lose points. Take care to ensure your points claim is correct.</li>`;
        } else {
            list.innerHTML += `<li>If you are currently outside of Australia, you can claim additional points for overseas employment experience once you have 3 years of work experience in your occupation. Also be aware of the risks. If some of your experience falls back past the last 10 years, you could lose points. Take care to ensure your points claim is correct.</li>`;
        }
        ...
        if (q9 == 20) {
            ...
            list.innerHTML += `<li>Claim additional points for employment experience once you have 3 years of work experience in your occupation.</li>`;
        } else {
